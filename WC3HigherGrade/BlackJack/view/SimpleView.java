...
//           
		...
		@Override
		public void displayStrategy(String hit, String win, String game) {
			System.out.println(" Strategy SET :");
			System.out.println("Hit Strategy : " + hit);
			System.out.println("Win Strategy : " + win);
			System.out.println("Game Strategy : " + game);
			System.out.println(" ------- ");
		}
    }
